...
function ProjectHomeScreen({ project, onOpenTab, onOpenTabInNewTab, onAskAI, onOpenDrawing, projectSwitcher, pinnedSet, onPin, skillRuns, skillCompletions, onStartSkillRun, onStopSkillRun, onConfigureBid, onCtxMenu, editMode, setEditMode, edits, recordEdit, revertEdits, editCount, onPushGlobal, divisionFormat, divisionFormatOther, hasPendingEdits, onPushToMaster, onOpenNotifications, notificationCount }) {
  ...
  const PROJECT_HOME_TOUR_STEPS = [
    ...
    { id: "runskill", selector: "[data-tour-id=\"project-run-skill\"]", placement: "above",
    ...
    { id: "bell", selector: ".taskbar-notify-btn", placement: "below",
      title: "Notifications",
      desc: "The bell shows who else is editing this project and what's waiting for approval — a one-click view of everything happening on this project right now." },
    { id: "clipboard", selector: "[data-tour-id=\"clipboard-panel\"]", placement: "left",
      title: "The Clipboard, scoped to this project",
      desc: "Open the Clipboard tab on the right to start a new Skill run or drop plans, specs, and bid files into the project — Cody indexes them automatically. Everything you see there is filtered to this project.",
